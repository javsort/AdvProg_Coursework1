...
public class PathFinder {
    ...
    It calls the findPath method, and in the case there's a path, prints the shortest path available while also highlighting the path itself.
    */
    public void doSearch(){
        ...
        if(!shortestPath.isEmpty()){
            ...
            // Iterate the list to set highlight, add to print string, and increase distance
            ...
            System.out.println("The shortest path has been printed and highlighted :).\n");                         // Remind user of the highlight
